...
async def cmd_about(message: Message):
    """Информация о курсе."""
    text = (
        "🎓 <b>Об онлайн-обучении</b>\n\n"
        "Наш курс разработан специально для тех, кто хочет получить практические навыки и выйти на новый уровень!\n\n"
        "🔹 <b>Формат:</b> Онлайн-уроки в закрытом канале, практические разборы и поддержка.\n"
        "🔹 <b>Длительность:</b> 2 месяца (осенний поток).\n"
        "🔹 <b>Результат:</b> Готовые навыки, обратная связь и доступ к закрытому комьюнити.\n\n"
        "💡 <i>Нажмите «🎓 Оплатить обучение» в главном меню, чтобы получить доступ.</i>"
    )
